...
To add this tap and install the GLPI Agent, run:
...
The cask is automatically updated when a new release is available on the official GLPI Agent repository via GitHub Actions.
